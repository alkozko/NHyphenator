...
namespace Test
{
    class Program
    {
		...
		public static void Test()
		{
			...
			var text1 = @"Vielleicht erinnerst du dich noch an deine Grundschulzeit, als die gesamte Klasse zu bestimmten Wörtern rhythmisch in die Hände geklatscht hat. Damals habt ihr gelernt, dass sich die Silbentrennung an Sprechsilben orientiert, die sich beim langsamen Sagen eines Wortes ergeben";
			var hyphenateText1 = new Hyphenator(HyphenatePatternsLanguage.German,"-").HyphenateText(text1);
